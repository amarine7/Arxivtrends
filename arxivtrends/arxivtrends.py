...
class Scraper(object):
    ...
    def __init__(self, macro_field):
        ...
        try:
            ...
            if self.query_dict.status == 404:
                raise Exception("404 - Page Not Found")
                print("The query was unsuccessful, parsing cannot begin.")
            elif self.query_dict.status == 400:
                raise Exception("400 - Bad Request")
                print("The query was unsuccessful, parsing cannot begin.")
            elif self.query_dict.status == 200:
    ...
    def scrape(self):
        ...
        total_time = t1 - t0
        print('fetching is completed in ' + str(datetime.timedelta(seconds = total_time)) + ' hours.')
